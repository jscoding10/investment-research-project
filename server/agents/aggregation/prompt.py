research_aggregation_prompt = """
    ...
    - swing_trade: Balanced approach. Technicals for entry/exit, Fundamentals/Industry for potential, Macro for headwinds, and Statistical Forecast.
    - position_trade: Prioritize Fundamental, Industry, and Macro sentiment. Technicals and News are less critical for long-term holding.
