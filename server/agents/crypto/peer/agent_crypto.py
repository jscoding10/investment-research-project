...
from agents.shared.crypto.llm_models_crypto import LLM_MODELS, get_groq_compound_llm
from agents.crypto.peer.prompt_crypto import peer_research_prompt

logger = get_logger(__name__)

dotenv.load_dotenv()

def get_peer_sentiment(ticker: str, name: str) -> str:
    """
    Retrieves structured peer-relative sentiment (POSITIVE/NEUTRAL/NEGATIVE) for the given crypto ticker
