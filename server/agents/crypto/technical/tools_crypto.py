...
from models.crypto.tools_crypto import TechnicalAnalysis, TechnicalAnalysisInput
...
def get_technical_analysis(ticker: str) -> TechnicalAnalysis:
    """
    Performs technical analysis on a crypto with standard investment indicators.
...
get_technical_analysis_tool = Tool(
    ...
    description="Use this tool to perform technical analysis on a crypto. Provide the ticker. The tool calculates RSI, Moving Averages (50/200 day), MACD, Stochastic Oscillator, and Bollinger Bands. Returns structured data with buy/sell signals and overall sentiment.",
