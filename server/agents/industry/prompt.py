industry_research_prompt = """
   ...
   You have access to Tavily search to retrieve LIVE, REAL-TIME information from the internet.
   Use this capability to search for and analyze the top 10 most relevant industry reports and analyses.

   CRITICAL: You are connected to Tavily search and can retrieve current information. The date provided below is the ACTUAL current date - use Tavily search to find recent articles and reports.
